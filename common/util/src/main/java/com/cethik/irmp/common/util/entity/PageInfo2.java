package com.cethik.irmp.common.util.entity;
 ...
 **/
public class PageInfo2<T> extends RowBounds {
    ...
    public PageInfo2(int pageNo, int pageSize) {
        this.pageNo = pageNo;
